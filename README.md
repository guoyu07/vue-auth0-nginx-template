# vue-auth0-nginx-template

> A frontend SPA template that acts as a proxy between endusers and auth0
> This template is an extension of the Browserify vue-template
...
$ vue init maxamante/vue-auth0-nginx-template my-project
$ cd my-project
$ npm install
$ npm run dev
```
